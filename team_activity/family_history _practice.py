...
def print_death_age(people_dict):
    ...
    Return: nothing
    """
    for key,inner_list in people_dict.items():
...
def print_marriages(marriages_dict, people_dict):
    ...
    Return: nothing
    """
    for key, inner_list in marriages_dict.items():
        husband_key = inner_list[HUSBAND_KEY_INDEX]
        wife_key = inner_list[WIFE_KEY_INDEX]
        wedding_year = inner_list[WEDDING_YEAR_INDEX]

        husband_info = people_dict[husband_key]
        wife_info = people_dict[wife_key]

        husband_name = husband_info[NAME_INDEX]
        husband_wedding_age = wedding_year - husband_info[BIRTH_YEAR_INDEX]
        wife_name = wife_info[NAME_INDEX]
        wife_wedding_age = wedding_year - wife_info[BIRTH_YEAR_INDEX]

        print(f"{husband_info[NAME_INDEX]} {husband_wedding_age} > {wedding_year} < {wife_name} {wife_wedding_age}")
